//frontend/components/admin/ServiceDetailsModal.jsx
...
export default function ServiceDetailsModal({
  ...
  useEffect(() => {
    apiClient
      .get(`/admin/services/${serviceId}/details`, {
        headers: {
    ...
    return (
      ...
      >
        ...
        <div className="space-y-2 text-sm">
          <div><strong>Category:</strong> {service.category_name}</div>
          <div><strong>Subcategory:</strong> {service.subcategory_name}</div>
